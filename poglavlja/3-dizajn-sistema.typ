...
Систем на слици @fig:dijagram-arhitekture је дизајниран као скуп независних компоненти које се могу извршавати 
...
Подаци о симулацијама организовани су по моделу једноставне табеле (као нпр. табела @tbl:simulation-data), 
