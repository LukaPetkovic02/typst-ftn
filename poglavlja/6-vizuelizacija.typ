...
За визуелизацију резултата симулације развијен је програмски модул у језику *Rust*, који користи библиотеку `plotters` за генерисање графичких приказа @plotters2025docs.
