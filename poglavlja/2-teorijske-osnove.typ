...
и најмања промена у почетним параметрима доводи до драстично различитих резултата. 
...
Основна идеја је да се вредност функције у следећем кораку одређује као пондерисана средина 
више „процена“ нагиба унутар истог временског интервала.
...
међурезултати. Коначна вредност $x_1$ добија се као пондерисана 
средина ових нагиба. 

Метода Рунге–Кута се показала као стабилна и ефикасна чак и код система 
са израженом нелинеарношћу и хаотичним понашањем, 
попут двоструког клатна, што је чини изузетно погодном за ову симулацију.
