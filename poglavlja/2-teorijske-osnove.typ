...
на почетне услове @wikipedia2025chaos. Иако се њихова еволуција управља детерминистичким једначинама, 
...
Положај система описује се угловима _θ₁_ и _θ₂_ у односу на вертикалу @allard2015.
...
Знак минус стоји испред јер се енергија система смањује кад тела иду надоле. @allard2015
...
у овом раду примењује се *метода Рунге–Кута четвртог реда (RK4)* @allard2015.  
...
На слици @fig:rk4 је приказано како се у сваком
...
Јако скалирање (слика @fig:strong_scaling) подразумева извршавање истог задатка (фиксиране величине проблема) 
на различитом броју процесора @hpcwiki2024.
...
#figure(
  image("../slike/strong_scaling.png", width: 70%),
  caption: [
    Јако скалирање
  ]
)<fig:strong_scaling>
...
Слабо скалирање (слика @fig:weak_scaling) подразумева пропорционално повећање величине проблема 
са бројем процесора @hpcwiki2024. У овом моделу, сваки процесор има приближно исти 
...
#figure(
  image("../slike/weak_scaling.png", width: 70%),
  caption: [
    Слабо скалирање
  ]
)<fig:weak_scaling>
...
Ово ограничење описује *Амдалов закон* @hpcwiki2024:
...
Из Амдаловог закона са слике @fig:amdalov_zakon произилази да чак и ако је 95% програма паралелно,  
...
Ову идеју описује *Густафсонов закон* @hpcwiki2024:
...
Густафсонов закон (слика @fig:gustafsonov_zakon) показује да се у пракси убрзање може приближити линеарном,  
