...
Слика @fig:rust_strong и табела @tbl:rust_strong_t описују јако скалирање. Као и у _Python_-у, симулирали смо 16 независних трајекторија, 
при различитом броју нити. Видимо да се убрзање креће близу Амдалове криве, што значи да се додавањем нових
нити постиже реална добит у брзини.

_Rust_ је постигао одлично јако скалирање, што је видљиво са графика. Tреба нагласити да је _Rust_ *компајлирани језик*
познат по високој ефикасности и минималним режијским трошковима. Узет је већи укупан посао у односу на _Python_ како би
додатно указали на мање време извршавања.

_Rust_ је показао врхунске апсолутне перформансе, што га чини погодним за израду научних симулација високих перформанси.
